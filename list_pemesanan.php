        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="javascript:void(0);" onclick="konfirmasiPenghapusan(<?php echo $data_pesanan['id_daftar_pesanan']; ?>); return false;">delete</a>
...
<script type="text/javascript">
    function konfirmasiPenghapusan(id_daftar_pesanan) {
        ...
        if (konfirmasi) {
            window.location.href = "proses_hapus.php?id_daftar_pesanan=" + encodeURIComponent(id_daftar_pesanan);
        }
    }
</script>
